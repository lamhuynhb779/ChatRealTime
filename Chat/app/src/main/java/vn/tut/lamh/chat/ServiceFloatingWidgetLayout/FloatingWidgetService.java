package vn.tut.lamh.chat.ServiceFloatingWidgetLayout;
...
import vn.tut.lamh.chat.ChatActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_activity_button:
                ...
                Intent intent = new Intent(FloatingWidgetService.this, ChatActivity.class);
